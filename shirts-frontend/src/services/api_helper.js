...
// get all shirt types
//  goes to http://localhost:3001/placeorder/step2
...
// get all shirt colors
//  goes to http://localhost:3001/placeholder/step3
export const allColorOptions = async() => {
    const resp = await api.get('/placeorder/step3');
    return resp;
}